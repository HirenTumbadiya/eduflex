    ...
    <footer className="bg-gray-800 py-4">
      <div className="container mx-auto px-4">
        <div className="flex flex-col justify-center items-center mt-2">
          <ul className="flex flex-col md:flex-row flex-wrap justify-center md:justify-start md:space-x-4 text-center">
            <li>
            ...
            <li>
              <a href="/contact-us" className="text-white hover:text-gray-400 transition-colors duration-300">Contact</a>
            </li>
            <li>
